...
import {div, gt, max,minus, multiple, number, plus, pow} from "../../libs/math"
import {
  decimal,
  format,
  isNative,
...
const FarmWizardStep3Form = ({
  ...
  const addVal1 = oldData.asset.token === token1 ? oldData.asset.amount :  (oldData.uusd.token === token1 ? oldData.uusd.amount : "0")
  const addVal2 = oldData.asset.token === token2 ? oldData.asset.amount :  (oldData.uusd.token === token2 ? oldData.uusd.amount : "0")
  ...
  console.log("Data", [...msgs, ...data, newContractMsg(lpToken, {
    increase_allowance: {
