      ...
      max:
        gt(findBalanceFn(token1) ?? "", "0")
          ? () => {
            ...
            setValue(Key.value1, symbol1.toUpperCase() === 'UST' ? decimal(minus(gte(bal, "5") ? bal : "0", gte(bal, "5") ? "5" : "0"), token1Detail?.decimals ?? 6) : decimal(bal, token1Detail?.decimals ?? 6))
          }
          : undefined,
      maxValue:
        gt(findBalanceFn(token1) ?? "", "0")
          ? () => {
            ...
            return Key.value1, symbol1.toUpperCase() === 'UST' ? decimal(minus(gte(bal, "5") ? bal : "0", gte(bal, "5") ? "5" : "0"), token1Detail?.decimals ?? 6) : decimal(bal, token1Detail?.decimals ?? 6)
          }
          : undefined,
