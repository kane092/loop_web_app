...
const DashboardHeader = ({collapseAble}:{collapseAble?:boolean}) => {
  ...
  return (
    <>
      ...
      { bound(<DashboardExchange formUpdated={formUpdated} collapseAble={collapseAble} />, <Card title='swap' >
      ...
      <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          <Summary
            ...
            title={
              <TooltipIcon content={"Farming APY"}>
                Farming APY
              </TooltipIcon>
            }
          >
            { bound(<FarmingAPR amount={cardsData?.maxFarmingApr ?? "0"} />,<LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
      ...
      <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          <Summary
            ...
            title={
              <TooltipIcon content={"Staking APR"}>
                Staking APR
              </TooltipIcon>
            }
          >
            { bound(<StakingAPR max_apr={cardsData?.maxStakingApr} />,<LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
          </Summary>
        </Card>
      </Grid>
      ...
      <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          ...
          >
           { bound(<Transactions transactions={cardsData?.last24Hourstransactions} />,<LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
          </Summary>
        </Card>
      </Grid>
      ...
      <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          ...
          >
           { bound(<Volume day7={cardsData?.volume7Days} hour24={cardsData?.volume24Hour} total={cardsData?.totalVolume} />, <LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
          </Summary>
        </Card>
      </Grid>
      ...
      <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          ...
          >
            { bound(<TransactionsFee fee={cardsData?.tradingFee} />, <LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
          </Summary>
        </Card>
      </Grid>
      ...
      <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          ...
          >
          { bound(<CirMarketCap amount={cardsData?.circulatingMarketCap} />,<LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
          </Summary>
        </Card>
      </Grid>

      { 
      !changed && <Grid className={styles.CzcardGrid}>
        <Card className={styles.card} mainSectionClass={styles.card_main}>
          <Summary
            labelClassName={styles.label}
          ...
          >
            {bound(<CirculatingSupply  amount={cardsData?.circulatingSupply ?? "0"} />,   <LoadingPlaceholder size={"sm"} className={styles.loading} color={"lightGrey"} /> )}
          </Summary>
        </Card>
      </Grid>
      }
