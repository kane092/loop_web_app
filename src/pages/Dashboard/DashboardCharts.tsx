  ...
  return (
    <>
      ...
      <Grid className={styles.chart_container}>
        ...
        <span className={styles.row}>
      {bound(<Card className={styles.maxCard}><CompateAllPairsChart collapseAble={props.collapseAble} setCollapseAble={props.setCollapseAble}  /></Card>,<Card className={styles.maxCard}><LoadingPlaceholder size={"sm"} color={"lightGrey"} /></Card>)
